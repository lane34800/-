...
/**
 * Arrays + Iteration
 * Most of your answers should be stored in variables called q5, q6 etc.. and the variables printed to the console.
  (i.e) console.log("Question 5" + q5)
 */
 ...
 */
var q5 = [1, 2, 3, 4];
q5.forEach(function increment(element, index, array) {
  element++;
  array[index] = element;
});
...
var q6 = 0;
q5.forEach(function add(element) {
  q6 += element; 
});
q6 = q6 / q5.length;
