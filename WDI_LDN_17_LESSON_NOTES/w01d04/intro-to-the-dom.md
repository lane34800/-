...
|-------------|------------|-------------|
| **Opening**: What is the DOM? | 5 mins | Explain the differneces between HTML and the DOM            
| **I Do**: Use a DOM object in javascript | 10 mins | Show how to use javscript to manipulate html
| **We Do**: Create a DOM object  | 10 mins |  With the students, create a DOM element usign javascript
| **We Do**: Different ways of accessing DOM elements | 15 mins | On an existing website, grab elements.    
| **We Do**: Setting and getting elements attributes and content| 10 mins| After matching elements, show how to get/set attributes to an element 
| **I DO**:A List of DOM Properties and Methods | 5 mins | A list of DOM methods to refer to  
| **Questions** | 5 mins |                                              
| **Closure** | 5 mins |  
...
Before Learning Jquery, Students should be able to manipulate the DOM with vanilla JS, so that they understand what happens behind the scene when the y use a library.
...
Students should have a basic understanding of javascript syntax and model object before this lesson. 
...
- [DOM](https://developer.mozilla.org/en-US/docs/Web/JavaScript/JavaScript_technologies_overview)
