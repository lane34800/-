...
- Describe the basic networking infrastructure of the internet
- Explain the request/response model
- Explain how browsers interpret responses
...
|-------------|------------|-------------|
| **Opening**: Quick history of the web | 10 mins | Overview of the main steps since internet exists    
| **I Do**: What Is the Difference Between the Internet and the Web? | 10 mins    | Describe the infrastructure and protocols behind the internet and how it differs from what we call the web        
| **I Do**: Server, Client, Request, HTTP? | 10 mins | Describe an http request and how it works with the client and the server.
| **I Do**: Request<>Response and then? | 10 mins | Explain how the web browser will interpret the data received from the server                     
| **Assess** | 10 mins |  Ask the students to describe a request<> response cycle with all the content learnt                                       
| **Questions** | 10 mins | 
...
Students will need to understand all these basic concepts about the web. internet and HTTP in order to be able to work with web frameworks and aim to create websites.
