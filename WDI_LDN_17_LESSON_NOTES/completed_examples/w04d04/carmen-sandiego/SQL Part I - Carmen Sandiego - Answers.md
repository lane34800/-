...
```SQL
SELECT name,population,code FROM country WHERE continent='Europe' ORDER BY population ASC;
```
...
```SQL
SELECT code,capital FROM country WHERE code='BRA';
```

**Answer:** 211

```SQL
SELECT id,name FROM city WHERE id=211;
```
